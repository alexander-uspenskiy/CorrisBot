...
- Ты ОБЯЗАН применять fail-closed send gate для всех обязательных отчетов (phase gates, summary). Никогда не завершай turn только отчетом в консоль (console-only report).
