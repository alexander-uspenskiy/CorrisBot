...
3. Если читал — почему нарушил ключевые правила роли (в частности не создал Worker и сделал реализацию сам).
...
- отдельно выдели правила про:
  ...
  - ожидание создания/переиспользования Workers.
...
- Orchestrator по факту сам написал скрипты в `C:\Temp\TestProject_3` и не создал Worker.
- Дай обоснование, это:
